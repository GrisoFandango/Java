...
public class Q5Module {
    ...
    public Q5Module(String code, String title, int level, int cwWeight, int exWeight){
        this.code = code;
        this.title = title;
        this.level = level;
    ...
    public void ask (String prompt){
        ...
        setCode(Console.askString("Code: "));
        setTitle(Console.askString("Title: "));
        setLevel(Console.askInt("Level: "));
        cwWeight = Console.askInt("cwWeight: ");
        exWeight = Console.askInt("exWeight: ");
        setWeights(cwWeight,exWeight);
    }
